...
public class CameraSource {
   ...
   * AutoFocusCallback#onAutoFocus(boolean)} callback will be called immediately. </p> <p>If the
   * current flash mode is not {@link Camera.Parameters#FLASH_MODE_OFF}, flash may be fired during
   * auto-focus, depending on the driver and camera hardware.<p>
   *
